...
FIELD_HEIGHT = 600
FIELD_WIDTH = 600
CLIENT_FIELD_HEIGHT = 300
CLIENT_FIELD_WIDTH = 400
MAX_USER = 9
...
PLAYER_SIGHT_CENTRAL_ANGLE = 3.141592 / 6  # ±30度
PLAYER_SIGHT_PERIPHERAL_ANGLE = 3.141592 / 3   # ±60度


BULLET_COLORS = ['', 'Red', 'Cyan', 'Lime', 'White', 'Coral', 'Gold', 'Thistle', 'Azure', 'Orange']
BULLET_COLOR_SMOKE = 'White'
BULLET_VELOCITY_NOMAL = 30 * (BASE_FPS/FPS)
BULLET_VELOCITY_BOMB = 10 * (BASE_FPS/FPS)
BULLET_VELOCITY_GRANADE = 5 * (BASE_FPS/FPS)
BULLET_VELOCITY_SMOKE = 5 * (BASE_FPS/FPS)

BULLET_LIFE_NOMAL = FPS * 1.5 # 通常のショットが消えるまでの時間
BULLET_LIFE_BOMB = FPS * 2 # ボムが消えるまでの時間
BULLET_LIFE_GRANADE = FPS * 4# グレネードの爆発までの時間(投射時間は1/5)
BULLET_LIFE_SMOKE = FPS * 4 # スモークが消えるまでの時間(投射時間は1/5)
...
BULLET_DAMAGE_BOMB = 5
BULLET_DAMAGE_GRANADE = 1
BULLET_DAMAGE_SMAKE = 0

# ショットのダメージ
BULLET_DAMAGE_NOMAL = 1
BULLET_DAMAGE_BOMB = 5
BULLET_DAMAGE_GRANADE = 0
BULLET_DAMAGE_SMOKE = 0
# ショットのサイズ
BULLET_SIZE_NOMAL = 6
BULLET_SIZE_BOMB = 12
BULLET_SIZE_GRANADE = 12
BULLET_SIZE_SMOKE = 15
